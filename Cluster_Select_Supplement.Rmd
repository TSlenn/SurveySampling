...
```{r NWDC}
zips <- tibble(zipcode = c(20004,20005,20008,20009,20036),
               pops = c(1717,13234,29527,51542,5836))
...
```{r Beth}
zips <- tibble(zipcode = c(20814,20815,20816,20817,20850,20851,20852,20855,20895),
               pops = c(29005,30476,16248,37226,33557,13038,34956,17251,18713))
